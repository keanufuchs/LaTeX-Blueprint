...
\addbibresource{literatur.bib}  % Pfad zur Literaturdatenbank
...
\input{anhang_codebeispielverzeichnis.tex}
...
\input{anhang_tabellen.tex}
\input{anhang_abbildungen.tex}
\input{anhang_codebeispiele.tex}
