...
[   twoside=false,     % Einseitiger oder zweiseitiger Druck?
    fontsize=11pt,     % Leitfaden: Fließtext 11 pt
    DIV=15,            % Randaufteilung (wird durch geometry überschrieben)
%    headsepline,
...
% Seitenränder nach Leitfaden RH Köln: links 3,5 cm, rechts 2,5 cm, oben 3 cm, unten 2 cm
\usepackage[left=3.5cm,right=2.5cm,top=3cm,bottom=2cm,headsep=0.5cm]{geometry}
...
\newcommand{\themaderarbeit}{Titel der Bachelorarbeit}
\newcommand{\fachbereich}{Fachbereich}
\newcommand{\studiengang}{Studiengang (B.Sc.)}
\newcommand{\erstpruefer}{Prof. Dr. Erstprüfer}
\newcommand{\zweitpruefer}{Prof. Dr. Zweitprüfer}
...
\pagestyle{scrplain}
\ihead[]{\fontsize{9}{13.5}\selectfont\headmark}
\ohead[]{}
\chead[]{}
\ifoot[]{\fontsize{9}{13.5}\selectfont\artderausarbeitung\ \namedesautors}
\ofoot[]{\fontsize{9}{13.5}\selectfont\pagemark}
\cfoot[]{}
...
\cleardoublepage
\pagenumbering{Roman} % Römische Seitenzahlen ab Kurzfassung (Leitfaden)
...
% Verzeichnisse nach Leitfaden: nach Kapiteln, vor Anhängen
...
% Abschlusserklärung (Pflicht – ohne diese: Note 5)
\input{meta/abschlusserklaerung.tex}

% Tabellarischer Lebenslauf (Pflicht, kein Portraitfoto)
\input{meta/lebenslauf.tex}
\end{document}
